...
* _type classes_ (limited operator overloading)
...
> The Valhalla team is currently working on the delivery of *JEP 401: Value Classes*. [...]
> Tentative schedule for integration is as follows:
>
> - OpenJDK review is in progress at https://github.com/openjdk/jdk/pull/31120[#31120].
> - [...]
> - Early July integration into OpenJDK mainline for JDK 28.

https://mail.openjdk.org/archives/list/jdk-dev@openjdk.org/thread/AIA3O3LHFZ6T7TIPH7KZT4WS4B6U72U5/[mail from June 8th, 2026]

[background-color="#151b23"]
=== !
image::images/jep401-pr.png[background, size=contain]
...
* 🎥 https://www.youtube.com/watch?v=Dhn-JgZaBWo[Valhalla - Java's Epic Refactor] (Dec 2024)
* 🎥 https://www.youtube.com/watch?v=Gz7Or9C0TpM[Growing the Java Language] (Aug 2025)
