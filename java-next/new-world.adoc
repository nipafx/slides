...
* https://access.redhat.com/articles/1299013[under guidance Red Hat's guidance]:
...
[quote]
____
https://aws.amazon.com/corretto/[Amazon Corretto] is a no-cost, multiplatform, production-ready distribution of the Open Java Development Kit (OpenJDK).
