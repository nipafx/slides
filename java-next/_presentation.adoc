...
:host-name: Java Saigon
:host-url: https://www.meetup.com/Java-Saigon/
:host-logo-url: images/logo-java-saigon.jpg
// :host-logo-style: background-color: transparent; border-width: 0;
:host-twitter-name: #JavaSaigon
:host-twitter-url: https://twitter.com/hashtag/JavaSaigon?src=hash
