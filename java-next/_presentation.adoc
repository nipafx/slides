...
:host-name: Garden State JUG
:host-logo-url: images/logo-gsjug.png
:host-url: https://gsjug.org/
// :host-logo-style: background-color: transparent; border-width: 0;
:host-twitter-name: @GardenStateJUG
:host-twitter-url: https://twitter.com/GardenStateJUG
