...
:host-name: Java Day Istanbul
:host-url: https://www.javaday.istanbul/
:host-logo-url: images/logo-javaday-istanbul.png
// :host-logo-style: background-color: transparent; border-width: 0;
:host-twitter-name: @javadayistanbul
:host-twitter-url: https://twitter.com/javadayistanbul
