...
// check for JCON: https://drive.google.com/drive/folders/14KY72U0RkrVSfptUy8XxsYDbP7K0-_Tq

:host-name: JavaDay @ JUG HH
:host-url: https://www.meetup.com/de-DE/jug-hamburg/
:host-logo-url: images/logo-java-day-oracle.png
