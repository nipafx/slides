...
JDK 20 (2023)::
* virtual threads (2nd preview; https://openjdk.org/jeps/436[JEP 436])
* structured concurrency (2nd incubator; https://openjdk.org/jeps/437[JEP 437])
* scope locals incubate (1st incubator; https://openjdk.org/jeps/429[JEP 429])
