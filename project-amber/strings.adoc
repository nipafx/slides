...
Java 21 will preview string templates (https://openjdk.org/jeps/430[JEP 430]):
...
* still needed in some form (e.g. for regex)
...
We hope that, in the future, we can "enable" rawness. 🤞 +
