...
:host-name: JUG Freiburg
:host-url: https://jugfr.de/
:host-logo-url: images/logo-jug-fr.jpg
// :host-logo-style: background-color: #111; border-color: #FFF;
:host-twitter-name: @jug_freiburg
:host-twitter-url: https://twitter.com/jug_freiburg
