...
:host-name: JUG Bremen
:host-url: https://www.meetup.com/jugbremen/
:host-logo-url: images/logo-jug-bremen.png
:host-logo-style: background-color: #FFF; border-color: #FFF;
:host-twitter-name: @jugbremen
:host-twitter-url: https://twitter.com/jugbremen
