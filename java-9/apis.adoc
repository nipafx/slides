...
```java
public List<Order> findOrdersForCustomer(String id) {
...
public Stream<Order> findOrdersForCustomer(String id) {
	return findCustomer(id)
		.stream()
...
public interface Customers {
	Optional<Customer> findInMemory(String id);
	Optional<Customer> findOnDisk(String id);
	Optional<Customer> findRemotely(String id);
}

public Optional<Customer> findCustomer(String id) {
	return customers.findInMemory(id)
		.or(() -> customers.findOnDisk(id))
		.or(() -> customers.findRemotely(id));
}
```
...
```java
public void logLogin(String id) {
	findCustomer(id)
