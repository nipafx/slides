...
:host-name: JUG Nürnberg
:host-url: https://www.xing.com/communities/groups/java-user-group-metropolregion-nuernberg-1063112
:host-logo-url: images/logo-jug-nuernberg.png
// :host-logo-style: background-color: transparent; border-width: 0;
:host-twitter-name: @JUGNBG
:host-twitter-url: https://twitter.com/JUGNBG
