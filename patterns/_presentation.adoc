...
:host-name: Java Forum Nord
:host-url: https://javaforumnord.de/2023/
:host-logo-url: images/logo-javaforumnord.png
:host-twitter-name: @JavaForumNord
:host-twitter-url: https://twitter.com/JavaForumNord/
