...
:host-name: Voxxed Days CERN
:host-url: https://cern.voxxeddays.com/
:host-logo-url: images/logo-voxxed-days-cern.png
:host-twitter-name: @VoxxedCERN
:host-twitter-url: https://twitter.com/VoxxedCERN
