...
:host-name: Infoshare
:host-url: https://infoshare.pl/conference/
:host-logo-url: images/logo-infoshare.png
// :host-logo-style: background-color: #212121; border-width: 0;
:host-twitter-name: @infosharepl
:host-twitter-url: https://twitter.com/infosharepl
