...
:host-name: AllTheTalks
:host-url: https://www.allthetalks.org/
:host-logo-url: images/logo-allthetalks.png
// :host-logo-style: border-color: black;
:host-twitter-name: @allthetalksconf
:host-twitter-url: https://twitter.com/allthetalksconf
...
// TODO: mention that we created the talk on Twitch and thank contributors
