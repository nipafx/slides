...
:host-name: DevTalks
:host-url: https://www.devtalks.ro/
:host-logo-url: images/logo-devtalks-ro-2021.png
// :host-logo-style: border-color: black;
:host-twitter-name: @DevTalksRo
:host-twitter-url: https://twitter.com/DevTalksRo
...
* take it all the way to *Java 16* +
  (and beyond)
...
* primitive classes | http://openjdk.java.net/projects/valhalla/[Project Valhalla]
...
* more expressive code | LOC: 2058 📉 1621
// characters: 69003 📉 58661
