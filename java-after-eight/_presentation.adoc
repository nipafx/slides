...
:host-name: Cloud Builders: Java Conf
:host-url: https://www.cloud-builders.tech/
:host-logo-url: images/logo-cloud-builders-java.png
:host-logo-style: background-color: transparent;
:host-twitter-name: @CloudBuildersUA
:host-twitter-url: https://twitter.com/CloudBuildersUA
...
* virtual threads | http://openjdk.java.net/projects/loom/[Project Loom]
...
* more expressive code | LOC: 2058 📉 1646
// characters: 69376 📉 59865
