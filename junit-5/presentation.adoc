...
:host-name: ETC
:host-url: http://europeantestingconference.eu
:host-logo-url: images/logo-etc.png
:host-twitter-name: #EuroTestConf
:host-twitter-url: https://twitter.com/hashtag/eurotestconf?src=hash
