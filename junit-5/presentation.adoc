...
:host-name: FFM Entwicklertag
:host-url: https://entwicklertag.de/frankfurt/2017/
:host-logo-url: images/logo-frankfurter-entwicklertag.png
:host-logo-style: background-color: #2D5352; border-color: #2D5352;
:host-twitter-name: #etffm17
:host-twitter-url: https://twitter.com/hashtag/etffm17s
