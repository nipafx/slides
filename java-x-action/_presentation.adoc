...
:host-name: JavaDay London
:host-logo-url: images/logo-java-day-oracle.png
:host-url: https://www.oracle.com/uk/developer/devlive/london/java/
:host-logo-style: background-color: transparent; border-width: 0;
:host-twitter-name: #OracleDevLive
:host-twitter-url: https://twitter.com/hashtag/OracleDevLive
