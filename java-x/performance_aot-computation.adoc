...
* class data caching with any GC (https://openjdk.org/jeps/516[JEP 516])
* code compilation (https://openjdk.org/jeps/8335368[JDK-833536])

=== More

_Supercharge your JVM performance with Project Leyden and Spring Boot_ +
(Ana-Maria Mihalceanu, Moritz Halbritter) +
Thursday, 11:50-12:40 @ Room 6
