...
:host-name: IT-Tage 2024
:host-url: https://www.ittage.informatik-aktuell.de/
:host-logo-url: images/logo-it-tage-2024.png
...
Smaller or under-the-hood changes:

* virtual threads don't pin on object monitors
* smaller runtime images (possibly)
////
