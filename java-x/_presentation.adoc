...
:host-name: Magnolia CMS
:host-url: https://www.magnolia-cms.com/
:host-logo-url: images/logo-magnolia.jpg
// :host-logo-style: background-color: transparent; border-width: 0;
:host-twitter-name:  @magnolia_cms
:host-twitter-url: https://twitter.com/magnolia_cms
...
* they cover Java 9 to 12 without JPMS; +
  we'll focus on Java 10 to 12 today
