...
:host-name: JUG Paderborn
:host-url: https://jug-pb.gitlab.io/
:host-logo-url: images/logo-jug-paderborn.png
:host-logo-style: background-color: white; border-color: transparent !important;
:host-twitter-name: @jugpaderborn
:host-twitter-url: https://twitter.com/jugpaderborn
...
include::language_flexible-constructors.adoc[]
