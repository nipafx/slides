...
:host-name: ByteMyCode
:host-url: https://bytemycode.pl
:host-logo-url: images/logo-bytemycode.png
// :host-logo-style: background-color: white;
:host-twitter-name: #ByteMyCode
:host-twitter-url: https://twitter.com/hashtag/ByteMyCode
