...
:host-name: OpenValue DUS
:host-url: https://www.meetup.com/de-DE/OpenValue-Dusseldorf/
:host-logo-url: images/logo-openvalue-dus.png
// :host-logo-style: background-color: unset;
:host-twitter-name: @OpenvalueG
:host-twitter-url: https://twitter.com/OpenvalueG
