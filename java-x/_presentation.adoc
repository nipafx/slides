...
:host-url: http://www.jug-ostfalen.de/
:host-logo-url: images/logo-jug-ostfalen.jpg
:host-twitter-name: @jug_ostfalen
:host-twitter-url: https://twitter.com/jug_ostfalen
